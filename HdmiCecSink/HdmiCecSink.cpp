...
//=========================================== HdmiCecSinkProcessor =========================================
       ...
       void HdmiCecSinkProcessor::process (const InitiateArc &msg, const Header &header)
       {
            ...
            if(!HdmiCecSink::_instance) 
	    return;
            if((HdmiCecSink::_instance->deviceList[0x5].m_physicalAddr.toString() == physical_addr_arc_port.toString() ) 
               || (HdmiCecSink::_instance->deviceList[0x5].m_physicalAddr.toString() == physical_addr_invalid.toString())){
